                        ...
                        <tbody>
                            <c:forEach items="${materials}" var="material">
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-${material.type == 'DOCUMENT' ? 'primary' : material.type == 'VIDEO' ? 'danger' : material.type == 'IMAGE' ? 'success' : 'info'}">${material.type}</span>
                                    </td>
                                    <td>${material.className}</td>
                                    <td>${material.teacherName}</td>
                                    <td>${material.uploadedAt}</td>
                                    <td>
                                        <c:if test="${material.fileName != null}">
                                            <a href="material?action=download&id=${material.materialId}" class="btn btn-sm btn-success">
                                                <i class="bi bi-download"></i> ${material.fileName}
                                            </a>
                                        </c:if>
                                        <c:if test="${material.fileName == null}">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="material?action=detail&id=${material.materialId}" class="btn btn-sm btn-info">View</a>
