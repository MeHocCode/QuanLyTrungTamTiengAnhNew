...
<body>
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="notification?action=create" class="btn btn-sm btn-outline-secondary">Create Notification</a>
                        </div>
                        <div class="btn-group">
                            <input type="text" class="form-control form-control-sm" placeholder="Search notifications..." id="searchInput">
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="searchNotifications()">Search</button>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="${notification.readFlag == 'UNREAD' ? 'table-primary' : ''}">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="notification?action=edit&id=${notification.notificationId}" class="btn btn-sm btn-warning">Edit</a>
    ...
    <script>
        function searchNotifications() {
            ...
            if (searchTerm.trim() === '') {
                window.location.href = 'notification?action=list';
            } else {
                window.location.href = 'notification?action=list&search=' + encodeURIComponent(searchTerm);
            }
        }
