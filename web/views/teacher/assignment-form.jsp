                        ...
                        <form method="post" action="assignment?action=create" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter assignment description..."></textarea>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="maxScore" name="maxScore" min="0" required placeholder="Enter maximum score...">
                                    </div>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="instructions" class="form-label">Instructions</label>
                                    <textarea class="form-control" id="instructions" name="instructions" rows="5" placeholder="Enter assignment instructions..."></textarea>
                                </div>
