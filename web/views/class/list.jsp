...
<body>
            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="${pageContext.request.contextPath}/admin/classes">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            <a href="${pageContext.request.contextPath}/admin/class?action=create" class="btn btn-sm btn-outline-secondary">Add Class</a>
                        </div>
                        <div class="btn-group">
                            <input type="text" class="form-control form-control-sm" placeholder="Search classes..." id="searchInput">
                            <button type="button" class="btn btn-sm btn-outline-secondary" onclick="searchClasses()">Search</button>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="class?action=delete&id=${class.classId}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                        </div>
                                    </td>
                                </tr>
                            </c:forEach>
    ...
    <script>
        function searchClasses() {
            ...
            if (searchTerm.trim() === '') {
                window.location.href = 'class?action=list';
            } else {
                window.location.href = 'class?action=list&search=' + encodeURIComponent(searchTerm);
            }
        }
