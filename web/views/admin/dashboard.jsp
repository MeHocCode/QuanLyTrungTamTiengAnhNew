...
<head>
    ...
    <title>Admin Dashboard - EduLingo</title>
                    ...
                    <div class="col-md-3">
                        <div class="card bg-success text-white">
                            <div class="card-body">
                                ...
                                <h2>${empty totalTeachers ? '0' : totalTeachers}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card bg-info text-white">
                            <div class="card-body">
                                ...
                                <h2>${empty totalCourses ? '0' : totalCourses}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                            ...
                            <div class="card-body">
                                <c:choose>
                                    <c:when test="${empty recentEnrollments}">
                                        <p class="text-muted">No recent enrollments yet.</p>
                                    </c:when>
                                    <c:otherwise>
                                        <div class="table-responsive">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${recentEnrollments}" var="enrollment">
                                                        <tr>
                            ...
                            <div class="card-body">
                                <c:choose>
                                    <c:when test="${empty systemStatus}">
                                        <p class="text-success">System is running normally</p>
                                    ...
                                    <c:otherwise>
                                        <div class="table-responsive">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${systemStatus}" var="status">
                                                        <tr>
                                                            <td>${status.component}</td>
                                                            <td>
                                                                <span class="badge bg-${status.status == 'ACTIVE' ? 'success' : 'danger'}">${status.status}</span>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
