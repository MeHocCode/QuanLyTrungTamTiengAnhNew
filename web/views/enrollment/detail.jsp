                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <strong>Email:</strong> ${enrollment.studentEmail}
                                    </div>
                                </div>
                                ...
                                <c:if test="${enrollment.status == 'PENDING'}">
                                    <div class="alert alert-warning mt-3">
                                        <strong>Pending Approval:</strong> This enrollment is waiting for admin approval.
                                        <div class="mt-2">
                                            <a href="enrollment?action=approve&id=${enrollment.enrollmentId}" class="btn btn-success">Approve</a>
                                            <a href="enrollment?action=reject&id=${enrollment.enrollmentId}" class="btn btn-danger">Reject</a>
                                        </div>
                                    </div>
                                </c:if>
                                ...
                                <c:if test="${enrollment.paymentStatus != 'PAID'}">
                                    <div class="alert alert-info mt-3">
                                        <strong>Payment Required:</strong> Please complete payment to activate enrollment.
                                        <div class="mt-2">
                                            <a href="payment?action=form&enrollmentId=${enrollment.enrollmentId}" class="btn btn-primary">Make Payment</a>
                                        </div>
                                    </div>
                                </c:if>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <a href="student?action=detail&id=${enrollment.studentId}" class="btn btn-info w-100">View Student</a>
                                    <a href="class?action=detail&id=${enrollment.classId}" class="btn btn-primary w-100">View Class</a>
                                    <a href="course?action=detail&id=${enrollment.courseId}" class="btn btn-success w-100">View Course</a>
                                    <c:if test="${enrollment.paymentStatus != 'PAID'}">
