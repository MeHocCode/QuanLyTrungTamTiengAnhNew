                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <c:if test="${enrollment.status == 'PENDING'}">
                                                <a href="enrollment?action=approve&id=${enrollment.enrollmentId}" class="btn btn-sm btn-success">Approve</a>
                                                <a href="enrollment?action=reject&id=${enrollment.enrollmentId}" class="btn btn-sm btn-danger">Reject</a>
                                            </c:if>
                                            <c:if test="${enrollment.paymentStatus != 'PAID'}">
                                                <a href="payment?action=form&enrollmentId=${enrollment.enrollmentId}" class="btn btn-sm btn-warning">Payment</a>
                                            </c:if>
                                        </div>
                                    </td>
                                </tr>
